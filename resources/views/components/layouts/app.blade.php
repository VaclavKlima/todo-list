...
<body class="bg-gradient-to-bl from-[#1b1b18] to-[#FDFDFC] dark:bg-gradient-to-bl dark:from-[#0a0a0a] dark:to-[#161615] min-h-screen relative overflow-hidden">
<div class="pointer-events-none absolute inset-0 z-0 overflow-clip">
    <!-- Top left blob -->
    <div class="absolute -top-24 -left-24 w-96 h-96 bg-gradient-to-tr from-yellow-300 via-pink-400 to-purple-400 opacity-30 rounded-full blur-3xl animate-spin-slow"></div>
    <!-- Bottom right blob -->
    <div class="absolute -bottom-32 -right-32 w-[32rem] h-[32rem] bg-gradient-to-br from-sky-300 via-cyan-400 to-blue-500 opacity-20 rounded-full blur-3xl"></div>
    <!-- Center swirl -->
    <div class="absolute top-1/2 left-1/2 w-2/3 h-2/3 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-tl from-lime-200 via-emerald-300 to-teal-400 opacity-10 rounded-full blur-[120px]"></div>
</div>
